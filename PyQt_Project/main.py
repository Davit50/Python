...
class Ui_Form(object):
    ...
    def setupUi(self, Form):
        ...
        self.radioButton.setStyleSheet(f"font:{width_ // 130}px \"MS Shell Dlg 2\";\n")

        self.radioButton_2.setStyleSheet(f"font:{width_ // 130}px \"MS Shell Dlg 2\";\n")
        self.radioButton_3.setStyleSheet(f"font:{width_ // 130}px \"MS Shell Dlg 2\";\n")
        self.label.setStyleSheet(f"font:{width_ // 130}px \"MS Shell Dlg 2\";\n")
...
class SecondForm(QWidget):
    ...
    def harcer(self, barer, name_):
        ...
        self.rb11 = QtWidgets.QRadioButton(self)
        self.rb11.resize(int(width_ * 0.07), int(height_ * 0.0185))
        self.rb11.move(int(width_ * 0.38), int(height_ * 0.12))
        self.rb11.setObjectName("rb11")

        self.rb12 = QtWidgets.QRadioButton(self)
        self.rb12.resize(int(width_ * 0.07), int(height_ * 0.0185))
        self.rb12.move(int(width_ * 0.49), int(height_ * 0.12))
        self.rb12.setObjectName("rb12")

        self.rb13 = QtWidgets.QRadioButton(self)
        self.rb13.resize(int(width_ * 0.07), int(height_ * 0.0185))
        self.rb13.move(int(width_ * 0.38), int(height_ * 0.17))
        self.rb13.setObjectName("rb13")

        self.rb14 = QtWidgets.QRadioButton(self)
        self.rb14.resize(int(width_ * 0.07), int(height_ * 0.0185))
        self.rb14.move(int(width_ * 0.49), int(height_ * 0.17))
        ...
        self.rb11.setText(question.h1(barer))
        self.rb12.setText(question.h2(barer))
        self.rb13.setText(question.h3(barer))
        self.rb14.setText(question.h4(barer))
        ...
        # for i in range(1, 9):
        #     for j in range(1, 5):
        #         globals()[f"bg{i}"].addButton(globals()[f"self.rb{i}{j}"])

        bg1.addButton(self.rb11)
        bg1.addButton(self.rb12)
        bg1.addButton(self.rb13)
        bg1.addButton(self.rb14)
        ...
        hbox1.addWidget(self.rb11)
        hbox1.addWidget(self.rb12)
        hbox1.addWidget(self.rb13)
        hbox1.addWidget(self.rb14)
    ...
    def Npage(self, tiv, barer, name_):
        def double_(self):
            if self.rb11.text()[-1] == ' ' and self.rb11.isChecked():
                self.score += 1
            ...
            if self.rb12.text()[-1] == ' ' and self.rb12.isChecked():
                self.score += 1
            ...
            if self.rb13.text()[-1] == ' ' and self.rb13.isChecked():
                self.score += 1
            ...
            if self.rb14.text()[-1] == ' ' and self.rb14.isChecked():
                self.score += 1
